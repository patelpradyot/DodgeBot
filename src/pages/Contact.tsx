        ...
        <div className="contact-container">
            <div className="contact-card">
                ...
                <div className="contact-details">
                    ...
                    <a href="tel:+919818021063" className="contact-item">
                        <FaPhone className="contact-icon phone-icon" />
                        <span>+91 9818021063</span>
                    </a>

                    <a href="https://www.linkedin.com/company/dodgebot" target="_blank" rel="noopener noreferrer" className="contact-item linkedin">
